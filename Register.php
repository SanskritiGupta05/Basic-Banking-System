...
<html lang="en">
    ...
    <style>
       *{
        ...
        .inp{
            ...
            outline: none;
            border-radius:60px;
            -webkit-box-shadow: -1px 1px 30px -11px hsl(136, 65%, 51%);;
            -moz-box-shadow: -1px 1px 30px -11px hsl(136, 65%, 51%);
            box-shadow: -1px 1px 30px -11px hsl(136, 65%, 51%);
        }
        .btn1{
            height:50px;
            width:50%;
  ...
  <body >
        ...
        <img src="icon-hamburger.svg" id="menuBtn">
